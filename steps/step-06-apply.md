...
문서 분리가 승인된 경우, Notion MCP를 사용하여 새 문서를 생성하고 내용을 분리합니다.

**6a. 신규 문서 생성**

Notion MCP `notion-create-pages`를 사용하여 원본 문서와 동일한 속성을 가진 새 문서 생성:
...
**백링크 형식:**
- 원본 문서: `> 📎 **관련 문서:** [신규 문서 제목](URL)`
- 신규 문서: `> 📎 **원본 문서:** [원본 문서 제목](URL)`
