...
### 18. 문서 분리 검토
문서가 지나치게 긴 경우 **분리**를 제안하고 신규 문서를 생성합니다.

| 분리 조건 | 기준 |
|----------|------|
| **물리적 길이** | 읽는 데 7~8분 이상 (약 3,500자 이상) |
| **주제 분산** | 2개 이상의 대주제가 한 문서에 혼재 |
| **구조 과도** | H1~H3 구조가 과도하게 복잡 (헤딩 15개 이상) |

**분리 시 처리:**
- Notion MCP로 원본과 동일한 속성의 신규 문서 생성
- 해당 내용을 신규 문서로 이동
- 원본↔신규 문서 간 **백링크 자동 추가**
...
flowchart TD
    ...
    S3["**STEP 3: 문서 검토**<br/>18가지 검토 항목 순차 검토<br/>검토 결과 요약"]
